...
public class MemberController {
  ...
  public MemberController(MemberService memberService, PostService postService,
      ImageStore imageStore, ResourceLoader resourceLoader) {
  ...
  @ResponseBody
  public Long signup(MemberRequestDto requestDto, @RequestParam MultipartFile file)
      throws IOException {
  ...
  public ResponseEntity<HttpHeaders> Login(@RequestBody LoginRequestDto loginRequestDto) {
    String token = memberService.Login(loginRequestDto.getMemberId(),
