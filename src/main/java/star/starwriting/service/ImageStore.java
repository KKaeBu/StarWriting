...
public class ImageStore {
  ...
  private final String basicPostImgPath =
      rootPath + pathSeperator("src/main/resources/static/img/postImg");
  private final String basicProfileImgPath =
      rootPath + pathSeperator("src/main/resources/static/img/profileImg");

  public String getFullPath(String filename) {
    return "/img/" + filename;
  }

  public MemberProfileImage storeProfileImage(MultipartFile file, Member member)
      throws IOException {
    ...
    String storeFileName =
        nowTimeStamp() + "-" + UUID.randomUUID() + "." + extractExt(originalFilename);
...
//        System.out.println("파일경로: " + fileDir);
    ...
    String fileUrl =
        membersPath + pathSeperator(member.getMemberId() + "/profileImg") + storeFileName;
    String fullPath =
        membersDir + pathSeperator(member.getMemberId() + "/profileImg") + storeFileName;
  ...
  // 글 작성시 사용된 이미지 저장 (미완)
  public PostImage storePostImage(String memberId, Post post, MultipartFile file)
      throws IOException {
    ...
    String fileUrl = membersPath + pathSeperator(memberId + "/posts/" + post.getTitle()) + "/img/"
        + storeFileName;
    String fullPath = membersDir + pathSeperator(memberId + "/posts/" + post.getTitle()) + "/img/"
        + storeFileName;
